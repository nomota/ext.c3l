...
fn usz? Request.content_length(&self);
...
fn usz? request_expected_total_len(char[] raw);
...
fn void Response.content_length(&self, usz value);
...
```c3
fn usz Response.serialized_len(&self);
fn usz Response.write_to(&self, char[] out);
